...
export const Footer = () => (
  <div style={{ paddingLeft: 56, paddingRight: 56,  backgroundColor: '#6202EE', height: 78, display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', textDecoration: 'none' }}>
